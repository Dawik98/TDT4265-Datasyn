...
def create_plots(trainer1: Trainer, trainer2: Trainer, name: str):
    ...
    utils.plot_loss(trainer2.train_history["loss"], label="Training loss w/ batchnorm", npoints_to_average=10)
    utils.plot_loss(trainer2.validation_history["loss"], label="Validation loss w/ batchnorm")
    plt.legend()
    plt.subplot(1, 2, 2)
    plt.title("Accuracy")
    utils.plot_loss(trainer1.validation_history["accuracy"], label="Validation Accuracy")
    utils.plot_loss(trainer2.validation_history["accuracy"], label="Validation Accuracy w/ batchnorm")
    plt.legend()
...
if __name__ == "__main__":
    ...
    trainer2.train()
    trainer2.get_final_results()

    create_plots(trainer1, trainer2, "task3d")
